...
public class TimeUnitUtils {
    ...
    /**
     * Конвертирует интервал в абстрактном TimeUnit в интервал в миллисекундах
     *
    ...
    /**
     * Конвертирует интервал в абстрактном TimeUnit в интервал в секундах
     *
     * @param unit интервал в TimeUnit
    ...
    /**
     * Конвертирует интервал в абстрактном TimeUnit в интервал в минутах
     *
     * @param unit интервал в TimeUnit
    ...
    /**
     * Конвертирует интервал в абстрактном TimeUnit в интервал в часах
     *
     * @param unit интервал в TimeUnit
